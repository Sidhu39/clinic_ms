...
Revision ID: 4b278cd33b0b
Revises: 
Create Date: 2025-06-14 15:06:09.417945
...
def upgrade():
    ...
    sa.Column('blood_pressure_high', sa.Integer(), nullable=True),
    sa.Column('blood_pressure_low', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['patient_id'], ['patient.patient_id'], ),
    sa.ForeignKeyConstraint(['slot_id'], ['appointment_slot.id'], ),
    sa.PrimaryKeyConstraint('id'),
